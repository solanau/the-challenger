...
const HeroSection = ({ eventId, title, body }: HeroSectionProps) => {
    ...
    return (
        <section
            className={cn(
                'relative flex min-h-[calc(100vh_+_40px)] w-full flex-col items-start overflow-hidden bg-gradient-to-b from-black to-transparent  sm:justify-start md:mt-0 md:min-h-[calc(100vh_+_300px)] md:min-h-0 md:flex-row md:justify-start lg:min-h-[calc(100vh)] lg:items-center lg:justify-center',
            )}
        ...
        >
            ...
            ></div>
            <div className="bp-backdrop _backdrop absolute left-0 z-10 h-full min-h-[calc(100vh_+_300px)] w-[70%] md:min-h-0 lg:min-h-[calc(100vh)]"></div>
            <div className="flex">
