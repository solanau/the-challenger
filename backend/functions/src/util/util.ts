...
export const PrestigeError = (type: string) => `Error writing on-chain ${type}. Check the logs.`;
export const DatabaseError = (type: string) => `Error writing ${type} to database.`;