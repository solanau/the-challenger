...
const Challenge: NextPage<ChallengePageProps> = ({ user, challenge }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            const submission = Object.keys(values)
                .map((key, index) => {
...
export const getServerSideProps: GetServerSideProps = async context => {
    ...
    const challenge = mockChallenges.find(
        challenge => challenge.id === context.params.id,
    );
    ...
    return {
        props: {
            user,
            challenge: await toChallenge(userIssues, challenge),
        },
    };
};
